...
//    UIImage *image = [UIImage IFR_imageWithUnicode:@"\U0000eb74" fontName:@"YQIconFont" backgroundColor:UIColor.groupTableViewBackgroundColor iconColor:UIColor.redColor size:CGSizeMake(64, 64) imageInsets:UIEdgeInsetsMake(4, 4, 4, 4) imageOrientation:UIImageOrientationDownMirrored];
    ...
    UIImage *image = [UIImage IFR_imageWithUnicode:@"\U0000eb74" fontName:@"YQIconFont" gradientColors:@[UIColor.blueColor, UIColor.yellowColor] gradientLocations:@[@(0.0), @(1.0)] gradientStartPoint:CGPointZero gradientEndPoint:CGPointMake(64, 64) iconColor:UIColor.redColor size:CGSizeMake(64, 64) imageInsets:UIEdgeInsetsZero imageOrientation:UIImageOrientationDownMirrored];
